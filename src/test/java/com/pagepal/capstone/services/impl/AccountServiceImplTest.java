...
public class AccountServiceImplTest {
    ...
    /**
     * Method under test: {@link AccountServiceImpl#registerStaff(AccountStaffCreateDto)}
     */
    @Test
    void canRegisterStaff() {
        ...
        AccountDto actualRegisterStaffResult = accountServiceImpl
                .registerStaff(new AccountStaffCreateDto("janedoe", "jane.doe@example.org", "Dr Jane Doe", "6625550144"));
        assertNull(actualRegisterStaffResult.getAccountState());
        assertNull(actualRegisterStaffResult.getWallet());
        assertNull(actualRegisterStaffResult.getUsername());
        assertNull(actualRegisterStaffResult.getRole());
        assertNull(actualRegisterStaffResult.getReader());
        assertNull(actualRegisterStaffResult.getPhoneNumber());
        assertNull(actualRegisterStaffResult.getPassword());
        assertNull(actualRegisterStaffResult.getLoginType());
        assertNull(actualRegisterStaffResult.getId());
        assertNull(actualRegisterStaffResult.getFullName());
        assertNull(actualRegisterStaffResult.getEmail());
        assertNull(actualRegisterStaffResult.getDeletedAt());
        assertNull(actualRegisterStaffResult.getCustomer());
        verify(accountRepository).save((Account) any());
        verify(accountRepository).findByUsername((String) any());
        verify(roleRepository).findByName((String) any());
        verify(accountStateRepository).findByNameAndStatus((String) any(), (Status) any());
